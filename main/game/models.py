...
class GameQuestion(models.Model):
    ...
    image = models.CharField('Путь к картинке вопроса', max_length=200, blank=True, null=True)
...
class Answer(models.Model):
    ...
    image = models.CharField('Путь к картинке', max_length=200, blank=True, null=True)
    order = models.IntegerField('Порядок', default=0)
    emotion_change = models.IntegerField('Изменение эмоционального состояния', default=0)
...
class UserProgress(models.Model):
    ...
    current_question = models.ForeignKey(GameQuestion, on_delete=models.SET_NULL, null=True)
